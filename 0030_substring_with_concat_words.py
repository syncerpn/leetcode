#1. we will use dict to lookup words as we slide through the given string
#2. the point is to keep track of the number of words appeared and adjust the sliding window accordingly
#3. this implementation tracks index; it is ok to track only number of occurences that when necessary, go back and remove invalid yet seen words during a sliding iter
