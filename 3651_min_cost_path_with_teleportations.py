# tried djikstra, but was failed to implement a good one
# someone confirm djikstra is possible
# anyway, i tried dp
# how much cost for each teleportation used
# just navigate it with every 1 <= ki <= k
class Solution:
